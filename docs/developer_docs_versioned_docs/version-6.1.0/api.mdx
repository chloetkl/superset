...
<details>
<summary><strong>Datasets</strong> (20 endpoints) — Manage datasets (tables) used for building charts.</summary>
...
| `POST` | Detect datetime formats for dataset columns | `/api/v1/dataset/{pk}/detect_datetime_formats` |
...
<details>
<summary><strong>Datasources</strong> (3 endpoints) — Query datasource metadata and column values.</summary>

| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | List datasets and semantic views combined | `/api/v1/datasource/` |
...
#### Semantic Layers (Feature Flag: SEMANTIC_LAYERS)

<details>
<summary><strong>Semantic Layers</strong> (8 endpoints) — Manage semantic layer connections and configurations.</summary>
...
<details>
<summary><strong>Semantic Views</strong> (5 endpoints) — Manage semantic views within semantic layers.</summary>

| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | Get semantic view structure (dimensions and metrics) | `/api/v1/semantic_view/{pk}/structure` |
| `POST` | Bulk create semantic views | `/api/v1/semantic_view/` |
...
<details>
<summary><strong>Tasks</strong> (4 endpoints) — Monitor and manage background tasks.</summary>

| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | Get a task | `/api/v1/task/{task_uuid}` |
| `GET` | Get task status (lightweight for polling) | `/api/v1/task/{task_uuid}/status` |
| `POST` | Cancel a task | `/api/v1/task/{task_uuid}/cancel` |
| `GET` | Get related subscribers | `/api/v1/task/related/subscribers` |

</details>

<details>
<summary><strong>Extensions</strong> (4 endpoints) — List and retrieve frontend extensions.</summary>

| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | List all enabled extensions | `/api/v1/extensions/` |
| `GET` | Get API info | `/api/v1/extensions/_info` |
| `GET` | Get an extension by its publisher and name | `/api/v1/extensions/{publisher}/{name}` |
